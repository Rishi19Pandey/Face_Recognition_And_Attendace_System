...
def contact():
    mess._show(title='Contact us',
               message="Please contact us on : 'rishikeshp082@gmail.com' ")
...
def TrainImages():
    ...
    message1.configure(text=res)
    message.configure(text=' Student Registred Sucessfully')   # + str(ID[0])
...
datef = tk.Label(frame4, text=day+"-"+mont[month]+"-"+year+"  |  ", fg="#ff61e5",
                 bg="#2d420a", width=55, height=1, font=('comic', 22, ' bold '))
